...
- Upgrades and any changes must to be transparent and well-documented with appropriate commit messages and comments.

## Conflict Resolution
- All the obstacles will be handled politely and quietly.
- The team will seek advice from the module tutor if the issue remains unresolved.
...
## Agreement
We declare to follow along by this Code of Conduct by participating in this project.
